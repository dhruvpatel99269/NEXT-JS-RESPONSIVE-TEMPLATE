...
export default function Home() {
        ...
        <nav className='text-right'>
          <div className='flex justify-between items-center'>
            <h1 className='font-bold uppercase p-4 border-b border-gray-100'>
              <a href='/' className='text-primary hover:text-gray-700'>Food Ninja</a>
            </h1>
          ...
          <ul className='text-sm mt-6 mt-6 hidden md:block' id='menu'>
            <li className="text-gray-600 font-bold p-2">
              <a href='#' className='px-4 py-1 flex justify-end border-r-4 border-primary'>
                <span>Home</span>
                <svg className='w-5 ml-1' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
            ...
            <li className='text-gray-600 font-bold p-2'>
              <a href='#' className='px-4 py-1 flex justify-end border-r-4 border-white'>
                <span>About</span>
                <svg className='w-5 ml-1' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
      ...
      <main className='px-16 py-6 bg-gray-100 text-black md:col-span-2'>
        ...
        <div>
          ...
          <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className='card hover:shadow-lg'>
              <Image src="/stew.jpg" alt="stew" className='w-full h-32 sm:h-48 object-cover'/>
              <div className='m-4'>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                ...
                <span className='text-black ml-1'>25 mins</span>
              </div>
            </div>
            <div className='card hover:shadow-lg'>
              <Image src="/noodles.jpg" alt="noodles" className='w-full h-32 sm:h-48 object-cover hover:zoom-125'/>
              <div className='m-4'>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            ...
            <div className='card hover:shadow-lg'>
              <Image src="/curry.jpg" alt="curry" className='w-full h-32 sm:h-48 object-cover'/>
              <div className='m-4'>
